          ...
          children: [
            ...
            Padding(
              ...
              child: ButtonBar(children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    if (_formKey.currentState!.validate() && (_image != null || widget.property != null)
                      // || _lng != null || _lat != null)) {
                      && _validCoords) {
                      ScaffoldMessenger.of(context).showSnackBar(
                      ...
                      try {
                        ...
                        if (widget.editMode == false) {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text('Updated property successfully')));
                          Navigator.pushReplacement(
                          context,
                            MaterialPageRoute(builder: (context) => PropertyPage(p)),
                          );
                        }
                  ...
                  child: widget.editMode ? const Text ('Update') : const Text('Add'),
                ),
              ]),
            ),
          ],
